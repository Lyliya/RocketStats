...
void RocketStats::onInit()
{
    ...
    cvarManager->registerCvar("rs_file_scores", (rs_file_score ? "1" : "0"), GetLang(LANG_FILE_SCORE), true, true, 0, true, 1, false).addOnValueChanged(std::bind(&RocketStats::RefreshFiles, this, std::placeholders::_1, std::placeholders::_2));
    ...
    cvarManager->registerCvar("rs_hide_scores", (rs_hide_score ? "1" : "0"), GetLang(LANG_HIDE_SCORE), true, true, 0, true, 1, false).addOnValueChanged(std::bind(&RocketStats::RefreshFiles, this, std::placeholders::_1, std::placeholders::_2));
